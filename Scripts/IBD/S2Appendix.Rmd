...
To distinguish recent migrants, we selected a threshold equal to 0.5 (dotted vertical lines, Fig \ref{fig:histMLA} to \ref{fig:histMLA_MKT}), labeling all comparisons above the threshold highly related. We then constructed logistic regression models, as outlined below, to quantify distance as a correlate of the probability of a comparison being highly related.
